...
func newWizardModel(th Theme, cat assets.Catalog, ollamaUp bool) *wizardModel {
	ti := textinput.New()
	ti.Prompt = "  "
	m := &wizardModel{
		theme:   th,
...
func buildWizardSteps(cat assets.Catalog, ollamaUp bool) []wizardStep {
...
func providerChoices(cat assets.Catalog, ollamaUp bool) []wizardChoice {
...
func RunOnboarding(cat assets.Catalog) (result WizardResult, ok bool, err error) {
